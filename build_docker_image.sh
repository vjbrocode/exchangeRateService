...
##
# This script builds docker image of the Exchange Rate Service
# Run this script AFTER compiling the code and building the exchangerateservice.jar in target folder
# 
...
readonly IMAGE=exchangerateservice
